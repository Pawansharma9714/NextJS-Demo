    ...
    <>
      <div className="wrapper">
        <section className="hero">
          <header className="bg-white sticky-top text-black-50">
              ...
              <nav className="navbar navbar-light navbar-toggleable-sm">
                ...
                >
                  <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                      <a className="nav-link" href="#sec-pricing">
                        Pricing
                      </a>
                    </li>

                    <li className="nav-item">
                      <a className="nav-link" href="#sec-testimonials">
                        Testimonials
                      </a>
                    </li>

                    <li className="nav-item">
                      <a className="nav-link" href="#sec-contact">
                        Contact
                      </a>
                    </li>
                  </ul>
              ...
              <div className="row justify-content-center text-center">
                <div className="col-md-10 col-lg-6">
                  ...
                  <p className="lead text-white">
                    Where you choose to work has impact on your productivity and
                    creativity. It also says a lot about your business. We are
          ...
          <div className="container">
            ...
            <div className="row align-items-center">
              ...
              <div className="col-md-6">
                ...
                <p>
                  A Czech business address for you and your mail. We can either
                  hold your mail for you to collect, or forward it on to
                  wherever you are.
                </p>
              </div>
            </div>
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                ...
                <p>
                  We’ll provide someone to answer your calls professionally
                  using your company name. They’ll be put through to you, or
                  we’ll take a message if you’re unavailable.
                </p>
              </div>
                ...
                <div className="card text-center p-4">
                  <div className="card-block">
                    ...
                    <p className="card-text">
                      The flexible place to grow your projects in a community of
                      start-ups, freelancers and entrepreneurs, flex desk.
                    </p>
              ...
              <div className="col-md-4">
                <div className="card text-center p-4">
                  <div className="card-block justify-content-center">
                    ...
                    <p className="card-text">
                      Your own private space, perfect for work teams of up to 50
                      people, inside a structure that’s always in motion
                    </p>
                  ...
                  <div className="row justify-content-center">
                    <div className="col-md-6">
                      <blockquote className="blockquote">
                        <small>
                          The vibe here is bright and very optimistic. Clients
                          love to visit us here and every day we make new
                          friends and contacts with other start-ups. Being a a
                ...
                <div className="carousel-item">
                  <div className="row justify-content-center">
                    <div className="col-md-6">
                      <blockquote className="blockquote">
                        <small>
                          I've been a memeber for over 3 years. We have always
                          been welcomed by friendly faces and helpful staff.
                          This co-working space has everything we need from
                          Wi-Fi to fresh and delicious coffee.
                        </small>
                ...
                <div className="carousel-item">
                  <div className="row justify-content-center">
                    <div className="col-md-6">
                      <blockquote className="blockquote">
                        <small>
                          I joined since its opening and I couldn't have found a
                          better working space. Being a member is so inspiring
                          and I love the work environment: spacious, bright and
                          full of entrepreneurs like me!
                        </small>
          ...
          <div className="container">
            <ul className="list-inline mb-0 text-center">
              <li className="list-inline-item">
                <a href="">
                  <span className="fa fa-twitter text-white mr-2"></span>
                </a>
              </li>

              <li className="list-inline-item">
                <a href="">
                  <span className="fa fa-google-plus text-white mr-2"></span>
                </a>
              </li>

              <li className="list-inline-item">
                <a href="">
                  <span className="fa fa-instagram text-white mr-2"></span>
                </a>
              </li>

              <li className="list-inline-item">
                <a href="">
                  <span className="fa fa-envelope-o text-white mr-2"></span>
                </a>
              </li>
            </ul>
          </div>
